...
class ColumnConfiguration
{
    ...
    /**
     * Currently graphql3 does not support inheritance of flex-forms.
     *
     * Therefore, we have this isser which makes sure the data-structure is of a simple type.
     *
     * Basically this means there is no ds_pointerField_searchParent config set.
     */
    public function isSimpleFlex(): bool
    {
        return
            $this->isFlex() &&
            $this->hasDataStructure() &&
            !$this->hasInheritedDataStructure() &&
            !empty($this->getDataStructure()['default']);
    }
